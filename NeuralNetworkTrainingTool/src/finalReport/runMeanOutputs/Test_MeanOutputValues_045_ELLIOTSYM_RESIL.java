 ...
 *
 */
public class Test_MeanOutputValues_045_ELLIOTSYM_RESIL {

    /**
     * The path to where we should be looking into for files 
     * to read and write.
     */
    private static final String PATH = "src/finalReport/runTest/test_045_ELLIOTSYM_RESIL/";

    /**
     * The base file name for the results to be stored into.
     */
    private static final String BASE_FILE_NAME = "test_MeanOutputValues_045_ELLIOTSYM_RESIL";

    /**
     * The Encog file with all network details to load and test.
     */
    private static final String ENCOG_FILE_NAME = "test_045_ELLIOTSYM_RESIL.encog";
