 ...
 *
 */
public class Test_MeanOutputValues_300_ELLIOTSYM_BKPROP {

    /**
     * The path to where we should be looking into for files 
     * to read and write.
     */
    private static final String PATH = "src/finalReport/runTest/test_300_ELLIOTSYM_BKPROP/";

    /**
     * The base file name for the results to be stored into.
     */
    private static final String BASE_FILE_NAME = "test_MeanOutputValues_300_ELLIOTSYM_BKPROP";

    /**
     * The Encog file with all network details to load and test.
     */
    private static final String ENCOG_FILE_NAME = "test_300_ELLIOTSYM_BKPROP.encog";
