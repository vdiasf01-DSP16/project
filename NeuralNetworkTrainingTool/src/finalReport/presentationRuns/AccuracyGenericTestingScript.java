package finalReport.presentationRuns;
 ...
 *
 */
public class AccuracyGenericTestingScript {

    /**
     * The path to where we should be looking into for files 
     * to read and write.
     */
    private static final String PATH = "src/finalReport/runTest/test_300x2_ELLIOTSYM_RESIL/";

    /**
     * The base file name for the results to be stored into.
     */
    private static final String BASE_FILE_NAME = "accuracy_generic_testing_script_results";

    /**
     * The Encog file with all network details to load and test.
     */
    private static final String ENCOG_FILE_NAME = "test_300x2_ELLIOTSYM_RESIL.encog";
