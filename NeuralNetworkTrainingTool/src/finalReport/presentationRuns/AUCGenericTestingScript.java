 ...
 *
 */
public class AUCGenericTestingScript {

    /**
     * The path to where we should be looking into for files to read and write.
     */
     ...
     */
    private static final String BASE_FILE_NAME = "auc_generic_testing_script_results";
