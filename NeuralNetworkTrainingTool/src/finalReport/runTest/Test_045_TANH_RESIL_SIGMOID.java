 ...
 *
 */
public class Test_045_TANH_RESIL_SIGMOID {
	 ...
	 * The base file name.
	 */
	private static final String BASE_FILE_NAME = "test_045_TANH_RESIL_SIGMOID";
	...
	/**
	 * The Activation Function to use at the output layer.
	 */
	private static final ActivationFunctionKey ACTIVATION_FUNCTION_KEY_OUTPUT = ActivationFunctionKey
			.ActivationSigmoid;
	...
	public static void main(String[] args) {
		...
		ActivationFunction afOutput = (ActivationFunction)ActivationFunctionFactory
				.getActivationFunction(ACTIVATION_FUNCTION_KEY_OUTPUT)
				.getActivationFunction();
		...
		((FeedForwardPattern)pattern).setActivationOutput(afOutput);
