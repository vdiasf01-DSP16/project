 ...
 *
 */
public class Test_1500x2_ELLIOTSYM_RESIL {
	 ...
	 * The base file name.
	 */
	private static final String BASE_FILE_NAME = "test_1500x2_ELLIOTSYM_RESIL";
	...
	public static void main(String[] args) {
		 ...
		 * Hidden layers
		 */
		pattern.addHiddenLayer(1500);
		pattern.addHiddenLayer(1500);
		int hiddenLayers = 2;
		String hiddenLayersSpec = "[ 1500 1500 ]";
