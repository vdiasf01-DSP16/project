 ...
 *
 */
public class Test_300x5_ELLIOTSYM_RESIL {
	 ...
	 * The base file name.
	 */
	private static final String BASE_FILE_NAME = "test_300x5_ELLIOTSYM_RESIL";
	...
	public static void main(String[] args) {
		...
		pattern.addHiddenLayer(300);
		int hiddenLayers = 5;
		String hiddenLayersSpec = "[ 300 300 300 300 300 ]";
