...
public class Test075TANHRPROP {
	 ...
	 * The base file name.
	 */
	private static final String BASE_FILE_NAME = "test_075_TANH_BPROP";
	...
	public static void main(String[] args) {
		...
		// Use Resilient Propagation training strategy.
		...
		// Cast to parent to set the thread count.
